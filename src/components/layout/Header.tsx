...
export function Header() {
  ...
  const navItems = [
    {
      ...
      hasDropdown: true,
      items: [
        { label: t("nav.cvVideo"), hash: "cv-video" },
        { label: t("nav.cvIA"), hash: "cv-ia" },
        { label: t("nav.simulation"), hash: "simulation" },
        { label: t("nav.matching"), hash: "matching" },
        { label: t("nav.guide"), hash: "guide" },
      ],
    },
    { label: t("nav.useCases"), hash: "cas-usage" },
    { label: t("nav.jobibox"), hash: "jobibox" },
    { label: t("nav.pricing"), hash: "tarifs" },
    { label: t("nav.deployment"), hash: "deploiement" },
  ];
  ...
  return (
    <>
      {/* Barre d'annonce + Header fixe */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-100 shadow-sm">
        {/* Announcement Banner */}
        <div className="announcement-gradient py-2.5 px-4 text-center text-white text-sm font-medium">
          <span className="inline-flex items-center gap-2">
            <span className="animate-pulse">✨</span>
            {t("announcement")}
            <AnchorLink to="plateforme" className="underline underline-offset-2 ml-2 hover:opacity-80 transition-opacity">
        ...
        {/* Main Header */}
        <header className="border-t border-gray-100/50">
